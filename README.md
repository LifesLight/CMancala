...
* **EGDB:** Endgame Database. Faster than LOCAL, but needs to calculate a database once beforehand. Use `egdb [N]` in config to enable. Supports loading the EGDB via MMAP and in LZ4 compressed form. No Avalanche support.
